...
> **Research question.** Can nighttime lights — generated outside the statistical agency — serve as a credible proxy for Indonesian GDP growth, nationally and provincially?
...
- **Independent of BPS.** Data pipeline from NASA's Black Marble is reproducible and transparent.
...
![Annual NTL in Indonesia, 2023](../fig/nitelite.png){width=70%}

- Java dominates.
- Stark contrast between Java and the rest of Indonesia — mirrors GDP distribution.
...
- Both series trend upward; visually non-stationary.
- **NTL barely dips during COVID** — a red flag we return to.
...
- Train/test forecast (holdout = 2024+).
:::
...
- Tests provincial heterogeneity explicitly.
:::
...
- Need a dynamic specification → ARDL.

## National: six ARDL specifications

![ARDL fits across six specifications](../fig/ARDLQ.png){width=80%}
...
![NTL vs GDRP across 34 provinces](../stata/fig/scatter_ntl.png){width=70%}

- Java clusters high on both axes.
- Resource provinces (Kalimantan, Papua) generate output without light.
- Agricultural provinces sit somewhere in between.
...
## Limitations & future work {.small}

- **Sample size**: 51 quarterly observations is tight for ARDL+Scar dfs.
- **Short OOS window**: rolling-origin forecasts needed.
- **Formal bounds test** (Pesaran–Shin–Smith) not reported — to be added.
- **Scarring identification**: try dummies starting 2022Q1 or 2023Q1; ECM reformulation.
- **Provincial heterogeneity**: interact NTL with province characteristics; cluster-wise elasticity by island group.
- **COVID-period divergence**: pair NTL with electricity dispatch, mobility, fiscal flow data.
...
::: {.small}
- Main paper: [github.com/imedkrisna/nitelite](https://github.com/imedkrisna/nitelite)
